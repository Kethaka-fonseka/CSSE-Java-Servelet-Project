...
<html lang="en">
  <head>
    <title> Home|LM Construction </title>
    <meta charset="utf-8">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <h6>jjjjjjjjjjjiiiiiiiiiiiiiii</h6>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <form method="GET" action="customerPayment.jsp">
					<input type="hidden" name="itemNo" value="items.getItemNo()"/>
					<button type="submit" class="btn btn-success btn-lg btn-block">Select&nbsp; &nbsp;<i class="fas fa-hand-pointer"></i></button>
				 </form>
