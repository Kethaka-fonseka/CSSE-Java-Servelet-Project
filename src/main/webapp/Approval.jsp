...
<div class="card m-5">
	<h4 style="text-transform: uppercase; font-weight: 600"
		class="form-titles  text-center mb-2 pt-3">Approval Requisitions</h4>
	<div class="m-2">
					...
					<div class="d-flex gap-3 justify-content-center mt-2 align-self-center">
						<div>
							<form action="ApproveServlet"method="post">
								...
								<button class="btn btn-light" type="submit" name="id"
									value="<%=list.getRequisitionNo()%>" >Approve
								</button>
							</form>
						</div>
						<div>
							<form action="ApproveServlet"method="post">
								...
								<button class="btn btn-danger" type="submit" name="id"  value="<%=list.getRequisitionNo()%>"> Decline
								</button>
							</form>
						</div>
					</div>
