...
<html lang="en">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 align-self-end text-center text-lg-right">
            <img src="images/new/about2.jpg" alt="Image" class="img-fluid img-1">
          </div>
    ...
    <div class="custom-border-bottom py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="landPage.jsp">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">About</strong></div>
        </div>
      </div>
    </div>
